---
name: update-trends
description: 更新热点快照数据。并行搜索五大平台（GitHub/HN/Product Hunt/出海/国内）最新热点，生成结构化 JSON，写入 tools/trends/data/trends.json。当用户说「更新热榜」「刷新热点」时使用。
type: workflow
---
