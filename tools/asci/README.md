...
| Q2：连续3次出错如何处理 | 假设生成路径：三次 ERROR → 降级策略面板 → 人工接管完整流程 |
...
| 任务 | 路径特点 | 覆盖题目 |
|------|---------|---------|
| 文献综述（默认） | 正常完成，含 Q1 风险标注、Q4 人工节点 | Q1、Q3、Q4 |
| 数据分析 | 触发黄色 WARN，展示中风险处理 | Q1、Q2（单次） |
| 假设生成 | 连续 3 次 ERROR → 人工介入全流程 | Q1、Q2（全流程）、Q4 |

> 当前 index.html 已实现文献综述完整路径；其他路径 Mock 数据待补充。
