...
对 AI 产品、技术演进、行业判断的持续记录，文章数量由元数据自动驱动，覆盖四类主题：

| 分类 | 代表文章 |
|------|---------|
| 技术 | RAG 的演进、大模型的下半场、工程演进三段论：从 Prompt 到 Harness |
| 产品 | AI POC 到底在验证什么、业务流程如何变成 Agent 产品架构、AI 产品记忆系统 |
| 商业 | 一份招股书里，两种不同节奏的“AI”、AI coding 之后，哪些 B 端 SaaS 会死，哪些会活 |
| 行业 | 半年之后，AI 办公从产品赛马走向体系竞争、从 WorkBuddy 到 FDE、2026 年 AI Agent 市场格局 |
